<template>
    <div class="interface-main-body">
      ...
      <el-form label-position="left" :model="form" :rules="rule_form" label-width="100px" class="demo-rule_form">
        ...
        <el-form-item label="方法" prop="method">
          <el-select v-model="rule_form.method" placeholder="请选择请求放啊">
        ...
        <el-form-item label="头部" prop="header">
          <editor v-model="rule_form.header" @init="editor_init" lang="json" theme="chrome" width="100%" height="150"></editor>
        </el-form-item>
        ...
        <el-form-item label="参数" prop="parameter">
          ...
          <editor v-if="'json' === rule_form.parameter_type" v-model="json_parameter" @init="editor_init"
                  lang="json" theme="chrome" width="100%" heiht="200"></editor>
          <div v-else>
            ...
            <div class="parameter-form-body" v-for="(value, index) in form_parameter" :key="index">
              ...
              <div class="padding-common">
                <el-select v-model="value.type" placeholder="请选择">
                  <el-optio label="整形" value="int"></el-optio>
                  <el-optio label="浮点型" value="float"></el-optio>
                  <el-optio label="字符串型" value="string"></el-optio>
                  <el-optio label="布尔型" value="bool"></el-optio>
                </el-select>
              </div>
              <div class="delete-bt">
        ...
        <el-form-item label="断言" prop="assertion">
          ...
          <div class="parameter-form-body" v-for="(value, index) in json_assertion" :key="index">
            ...
            <div class="padding-common">
              <el-input v-mode="value.value" placeholder="内容"></el-input>
            </div>
        ...
        <el-form-item>
          ...
          <el-button @click="reset_from('rule_form')">重置</el-button>
        </el-form-item>
      </el-form>
    </div>
</template>
    ...
    export default {
      ...
      methods: {
        editor_init: function () {
          require('brace/ext/language_tools'); // 语言扩展 prerequsite
          require('brace/mode/json');
          require('brace/theme/chrome');
          require('brace/snippets/javascript'); // snippet 片段
        },
